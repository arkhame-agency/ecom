...
<body id="maintenance"
      ...
      style="--color-primary: #{{ $themeColor->getHex() }};
          ...
          --color-primary-complementary: #{{ $themeColor->complementary() }};
...
<div class="container">
    <div class="d-flex align-center">
        <div class="col-L">
            ...
            <h1>
                {{ trans('storefront::503.maintenance') }}
            </h1>
            <h2>
                {{ trans('storefront::503.we_are_currently_performing_scheduled_maintenance') }}
            </h2>
            <hr>
            <p>
                {{ trans('storefront::503.be_back_message') }}
            </p>
        </div>
        <div class="col-R">
