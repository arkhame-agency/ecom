<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::select('brands', trans('coupon::attributes.brands'), $errors, $brands, $coupon, ['class' => 'selectize prevent-creation', 'multiple' => true]) }}
        {{ Form::select('exclude_brands', trans('coupon::attributes.exclude_brands'), $errors, $brands, $coupon, ['class' => 'selectize prevent-creation', 'multiple' => true]) }}
    </div>
</div>
