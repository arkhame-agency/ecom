        ...
        <div class="product__items ">
            <div class="product__items--thumbnail">
                ...
                <ul class="product__items--action d-flex justify-content-center">
                    <li class="product__items--action__list">
                        <a
                            :class="{ 'added': inWishlist, 'product__items--action__btn' : true }"
                    ...
                    <li class="product__items--action__list">
                        <a class="product__items--action__btn" :class="{ 'added': inCompareList }"
            ...
            <div class="product__items--content text-center">
                ...
                <div class="product__items--price">
                    <!--                <span class="current__price" v-if="product.has_percentage_special_price">-->
                    <!--                    {{ product.special_price_percent }}%-->
                    <!--                </span>-->
                    <span class="current__price" v-html="product.formatted_price">
                    $-.--
                </span>
                </div>
