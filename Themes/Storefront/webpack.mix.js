...
mix.js(`${__dirname}/resources/assets/admin/js/main.js`, `${__dirname}/assets/admin/js/storefront.js`)
    ...
    .js(`${__dirname}/resources/assets/public/js/script.js`, `${__dirname}/assets/public/js/script.js`)
    ...
    .copy(`${__dirname}/resources/assets/public/css/swiper-bundle.min.css`, `${__dirname}/assets/public/css`)
    .copy(`${__dirname}/resources/assets/public/css/glightbox.min.css`, `${__dirname}/assets/public/css`)
