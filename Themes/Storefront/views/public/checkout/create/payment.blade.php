<div class="payment__history mb-30 checkout__total" v-cloak>
    <h3 class="payment__history--title mb-20">{{ trans('storefront::checkout.payment_method') }}</h3>
    <div class="payment-method checkout-form">
