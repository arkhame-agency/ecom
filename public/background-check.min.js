...
! function (a,b) {
    ...
    function a(a) {
        ...
        } else b = m(a),d = a.el,c = a.img;d = d.getBoundingClientRect(),b.imageTop = 0,b.imageLeft = 0,b.imageWidth = c.naturalWidth,b.imageHeight = c.naturalHeight;var f,g = b.imageHeight / b.height;return b.top < d.top && (f = d.top - b.top,b.imageTop = g * f,b.imageHeight -= g * f,b.top += f,b.height -= f),b.left < d.left && (f = d.left - b.left,b.imageLeft += g * f,b.imageWidth -= g * f,b.width -= f,b.left += f),b.bottom > d.bottom && (f = b.bottom - d.bottom,b.imageHeight -= g * f,b.height -= f),b.right > d.right && (f = b.right - d.right,b.imageWidth -= g * f,b.width -= f),b.imageTop = Math.floor(b.imageTop),b.imageLeft = Math.floor(b.imageLeft),b.imageHeight = Math.floor(b.imageHeight),b.imageWidth = Math.floor(b.imageWidth),b;
    } function o(a) {
        ...
        var d = a.className;switch (c) {
            case 'add':d += ' ' + b;break;case 'remove':var e = new RegExp('(?:^|\\s)' + b + '(?!\\S)','g');d = d.replace(e,'');
        }a.className = d.trim();
    } function q(a) {
        ...
        var b,d,e,f,g = a.getBoundingClientRect(),h = 0,i = 0,j = 0,k = 0,l = z('mask');if (g.width > 0 && g.height > 0) {
        ...
        var b = function (a) {
            ...
            },c = a.parentNode,d = c ? b(c) : 0,e = b(a);return 1e5 * d + e;
    } function v(a) {
        var b = ! 1;return a.sort(function (a,c) {
            a = a.nodeType ? a : a.el,c = c.nodeType ? c : c.el;var d = a.compareDocumentPosition(c),e = 0;return a = u(a),c = u(c),a > c && (b = ! 0),a === c && 2 === d ? e = 1 : a === c && 4 === d && (e = -1),e || a - c;
        }),c('Sorted: ' + b),b && c(a),b;
    } function w(a,b,d) {
        if (B) {
    ...
    } var B,C,D,E,F,G = void 0 !== window.orientation ? 'orientationchange' : 'resize',H = {};return { init:a,destroy:b,refresh:w,set:y,get:z,getImageData:A };
});
